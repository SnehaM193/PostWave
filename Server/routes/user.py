...
def create_user(user_to_create: user_schemas.UserCreate, db: Session = Depends(get_db)):
...
def update_users(user_id: int, updated_data: user_schemas.UserCreate,db: Session = Depends(get_db)):
